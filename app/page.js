        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
            ...
            <p className="font-body text-white/70 text-lg max-w-2xl mx-auto mb-12 leading-relaxed opacity-0 animate-slide-up animate-delay-300">
              Building scalable software by day. Helping athletes own the stage by night. 
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-white/50 max-w-xl mx-auto">
                Three disciplines, one philosophy: pursue excellence through discipline, 
              ...
              <Link href="/engineering" className="group">
                <div className="card card-hover p-8 h-full flex flex-col">
                  ...
                  <p className="text-white/60 mb-6 flex-grow">
                    Building scalable cloud solutions in healthcare tech. Specializing in 
                    .NET, AWS/Azure, and AI-powered automation systems.
                  </p>
              ...
              <Link href="/photography" className="group">
                <div className="card card-hover p-8 h-full flex flex-col">
                  ...
                  <p className="text-white/60 mb-6 flex-grow">
                    ...
                    Available for portraits, fitness, and event photography.
                  </p>
        ...
        <section className="py-24 lg:py-32">
          <div className="max-w-4xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-8">
              Competitive classic physique bodybuilder. Sneaker collector with 80+ pairs of Jordans. 
